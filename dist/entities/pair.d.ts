...
export declare class Pair {
    ...
    static getAddress(tokenA: Token, tokenB: Token, pancakeswap: boolean): string;
    constructor(tokenAmountA: TokenAmount, tokenAmountB: TokenAmount, pancakeswap: boolean);
    /**
