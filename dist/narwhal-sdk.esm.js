...
var WBNB = (_WBNB = {}, _WBNB[ChainId.MAINNET] = /*#__PURE__*/new Token(ChainId.MAINNET, '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', 18, 'WBNB', 'Wrapped BNB'), _WBNB[ChainId.TESTNET] = /*#__PURE__*/new Token(ChainId.TESTNET, '0x0000000000000000000000000000000000000000', 18, 'WBNB', 'Wrapped BNB'), _WBNB);
...
var Pair = /*#__PURE__*/function () {
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB, pancakeswap) {
    ...
    if (((_PAIR_ADDRESS_CACHE$k = PAIR_ADDRESS_CACHE[key]) === null || _PAIR_ADDRESS_CACHE$k === void 0 ? void 0 : (_PAIR_ADDRESS_CACHE$k2 = _PAIR_ADDRESS_CACHE$k[tokens[0].address]) === null || _PAIR_ADDRESS_CACHE$k2 === void 0 ? void 0 : _PAIR_ADDRESS_CACHE$k2[tokens[1].address]) === undefined) {
      ...
      PAIR_ADDRESS_CACHE[key] = _extends({}, PAIR_ADDRESS_CACHE[key], (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, (_PAIR_ADDRESS_CACHE$k3 = PAIR_ADDRESS_CACHE[key]) === null || _PAIR_ADDRESS_CACHE$k3 === void 0 ? void 0 : _PAIR_ADDRESS_CACHE$k3[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = getCreate2Address(pancakeswap ? FACTORY_ADDRESS_CAKE : FACTORY_ADDRESS_APE, keccak256(['bytes'], [pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), pancakeswap ? INIT_CODE_HASH_CAKE : INIT_CODE_HASH_APE), _extends2)), _extends3));
    }
...
export { ChainId, Currency, CurrencyAmount, ETHER, FACTORY_ADDRESS_APE, FACTORY_ADDRESS_CAKE, Fetcher, Fraction, INIT_CODE_HASH_APE, INIT_CODE_HASH_CAKE, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, Pair, Percent, Price, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, WBNB, currencyEquals, encodePathToken, inputOutputComparator, tradeComparator };
