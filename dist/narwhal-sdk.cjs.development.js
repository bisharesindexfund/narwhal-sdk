...
var FACTORY_ADDRESS_APE = '0x0841BD0B734E4F5853f0dD8d7Ea041c241fb0Da6';
var FACTORY_ADDRESS_CAKE = '0xBCfCcbde45cE874adCB698cC183deBcF17952812';
var INIT_CODE_HASH_APE = '0xf4ccce374816856d11f00e4069e7cada164065686fbef53c6167a63ec2fd8c5b';
var INIT_CODE_HASH_CAKE = '0xd0d4c4cd0848c93cb4fd1f498d7013ee6bfb25783ea21593d5834f5d250ece66';
...
var WBNB = (_WBNB = {}, _WBNB[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', 18, 'WBNB', 'Wrapped BNB'), _WBNB[exports.ChainId.TESTNET] = /*#__PURE__*/new Token(exports.ChainId.TESTNET, '0x0000000000000000000000000000000000000000', 18, 'WBNB', 'Wrapped BNB'), _WBNB);
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB, pancakeswap) {
    this.pancakeswap = pancakeswap;
    var tokenAmounts = tokenAmountA.token.sortsBefore(tokenAmountB.token) // does safety checks
    ? [tokenAmountA, tokenAmountB] : [tokenAmountB, tokenAmountA];
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token, pancakeswap), 18, 'APE-V2', //TODO
    'ApeSwap V2');
    this.tokenAmounts = tokenAmounts;
  }

  Pair.getAddress = function getAddress(tokenA, tokenB, pancakeswap) {
    var _PAIR_ADDRESS_CACHE$k, _PAIR_ADDRESS_CACHE$k2;

    var tokens = tokenA.sortsBefore(tokenB) ? [tokenA, tokenB] : [tokenB, tokenA]; // does safety checks

    var key = pancakeswap ? 'pancakeswap' : 'apeswap';

    if (((_PAIR_ADDRESS_CACHE$k = PAIR_ADDRESS_CACHE[key]) === null || _PAIR_ADDRESS_CACHE$k === void 0 ? void 0 : (_PAIR_ADDRESS_CACHE$k2 = _PAIR_ADDRESS_CACHE$k[tokens[0].address]) === null || _PAIR_ADDRESS_CACHE$k2 === void 0 ? void 0 : _PAIR_ADDRESS_CACHE$k2[tokens[1].address]) === undefined) {
      var _PAIR_ADDRESS_CACHE$k3, _extends2, _extends3;

      PAIR_ADDRESS_CACHE[key] = _extends({}, PAIR_ADDRESS_CACHE[key], (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, (_PAIR_ADDRESS_CACHE$k3 = PAIR_ADDRESS_CACHE[key]) === null || _PAIR_ADDRESS_CACHE$k3 === void 0 ? void 0 : _PAIR_ADDRESS_CACHE$k3[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = address.getCreate2Address(pancakeswap ? FACTORY_ADDRESS_CAKE : FACTORY_ADDRESS_APE, solidity.keccak256(['bytes'], [solidity.pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), pancakeswap ? INIT_CODE_HASH_CAKE : INIT_CODE_HASH_APE), _extends2)), _extends3));
    }
...
function encodePathToken(token, pancakeswap) {
  return ['0x', token.address.slice(2).padStart(62, '0'), pancakeswap ? '01' : '00' // TODO check it twice
  ].join('');
}
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    var encodedPath = [encodePathToken(path[0], pairs[0].pancakeswap)];
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(pairs.entries()), _step; !(_step = _iterator()).done;) {
      ...
      path.push(_output);
      var pancakeswap = false;

      if (i < pairs.length - 1) {
        pancakeswap = pairs[i + 1].pancakeswap;
      }

      encodedPath.push(encodePathToken(_output, pancakeswap));
    }
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    var amountOut = toHex(trade.minimumAmountOut(options.allowedSlippage)); // const path: string[] = trade.route.path.map(token => token.address)

    var encodedPath = trade.route.encodedPath;
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, pancakeswap, provider) {
    try {
      ...
      var address = Pair.getAddress(tokenA, tokenB, pancakeswap);
...
exports.ETHER = ETHER;
exports.FACTORY_ADDRESS_APE = FACTORY_ADDRESS_APE;
exports.FACTORY_ADDRESS_CAKE = FACTORY_ADDRESS_CAKE;
exports.Fetcher = Fetcher;
exports.Fraction = Fraction;
exports.INIT_CODE_HASH_APE = INIT_CODE_HASH_APE;
exports.INIT_CODE_HASH_CAKE = INIT_CODE_HASH_CAKE;
